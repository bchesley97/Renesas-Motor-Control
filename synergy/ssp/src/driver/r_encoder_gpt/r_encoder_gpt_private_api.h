...
#ifndef R_ENCODER_PRIVATE_API_H
#define R_ENCODER_PRIVATE_API_H

/***********************************************************************************************************************
 * Private Instance API Functions. DO NOT USE! Use functions through Interface API structure instead.
 **********************************************************************************************************************/
ssp_err_t R_ENCODER_Open 	    (encoder_ctrl_t * const p_ctrl, encoder_cfg_t const * const p_cfg);
ssp_err_t R_ENCODER_Reset 		(encoder_ctrl_t * const p_ctrl);
